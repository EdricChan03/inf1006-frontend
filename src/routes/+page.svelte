  ...
  >
    <header class="flex justify-between">
      ...
      <button
        ...
        class="bg-sky-200 hover:bg-sky-300 active:bg-sky-400 rounded shadow border-2 border-sky-400 focus:ring focus-visible:outline-none focus:ring-sky-500 transition-all p-3"
      >
        <RefreshCwIcon />
      </button>
    </header>
